    ...
    <Container safeArea edges={['top']} style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.dashboard}>
          ...
          >
            <Text style={styles.heroTitle}>{t('dashboard.patient_overview')}</Text>
            <View style={styles.heroStatsRow}>
              <View style={styles.heroStatItem}>
                <Text style={styles.heroStatValue}>{stats?.totalPatients || 0}</Text>
                <Text style={styles.heroStatLabel}>{t('dashboard.assigned')}</Text>
              </View>
              <View style={styles.heroStatDivider} />
              <View style={styles.heroStatItem}>
                <Text style={styles.heroStatValue}>{stats?.totalTrackedPatients || 0}</Text>
                <Text style={styles.heroStatLabel}>{t('dashboard.tracked_patients')}</Text>
              </View>
              <View style={styles.heroStatDivider} />
              <View style={styles.heroStatItem}>
          ...
          <View style={styles.actionsGrid}>
            <ActionCard title={t('dashboard.track_patient')} icon="navigate-outline" color={colors.primary} route="/(chw)/features/track-patient" />
            <ActionCard title={t('dashboard.report')} icon="document-text-outline" color={colors.primaryDark} route="/(chw)/features/submit-report" />
            <ActionCard title={t('dashboard.view_tracked_patients')} icon="people-circle-outline" color={colors.primaryLight} route="/(chw)/features/view-tracked-patients" />
            <ActionCard title={t('dashboard.patient_list')} icon="people-outline" color={colors.success} route="/(chw)/(tabs)/patients" />
          </View>
